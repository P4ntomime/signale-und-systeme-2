...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_pol_in_ursprung.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_nullstelle_in_ursprung.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \myul{Betrag zeichnen}
...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_reeller_pol.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \myul{Betrag zeichnen}
...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_reelle_nullstelle.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_konjuguert-komplexe_pole.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \myul{Betrag zeichnen}
...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_konjuguert-komplexe_nullstellen.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \myul{Betrag zeichnen}
...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \include{tikz/bode-plot_konstanter_faktor.tex}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \raggedright
...
\begin{minipage}[c]{0.47\columnwidth}
    \input{tikz/konjugiert_komplexe_pole_q_1.tex}
\end{minipage}
...
\begin{minipage}[c]{0.52\columnwidth}
    \begin{tabular}{ll}
            ...
            \strut Höhe:      & $ \abs{H(\omega_{\max})} = \infty$   % CHECK: macht das Sinn???
    \end{tabular}
\end{minipage}
\hfill
\begin{minipage}[c]{0.47\columnwidth}
    \input{tikz/konjugiert_komplexe_pole_q_05.tex}
\end{minipage}
...
\begin{minipage}[c]{0.44\columnwidth}
    \input{tikz/konjugiert_komplexe_pole_q_1_wurzel2.tex}
\end{minipage}
