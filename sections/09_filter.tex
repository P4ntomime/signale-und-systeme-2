...
% --------------------------------------------------------------------------------------------------
\subsection{Approximation nach Tschebyscheff-\uproman{1}}
...
%TODO: ändern
\subsubsection{Eigenschaften der Tschebyscheff-\uproman{1}-Approximation}
...
\subsection{Approximation nach Tschebyscheff-\uproman{2}}
...
\subsection{Approximation nach Cauer}
...
\begin{tabular}{|l|c|c|c|c|c|c|}
    ...
    \textbf{DB}            & streng monoton                                                     & \begin{tabular}[c]{@{}c@{}}streng monoton\\ steilstmöglich\end{tabular} & streng monoton                                        & \begin{tabular}[c]{@{}c@{}}wellig\\ konst. Rippel\end{tabular} & wellig               & streng monoton                                           \\ \hline
...
\subsubsection{Frequenzgänge / Lage der Pol- und Nullstellen}
